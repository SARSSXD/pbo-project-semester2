...
interface Inter {
    ...
    String simpanData(int id_ustad, String nama_ustad, String kelas);

    String ubahData(int id_ustad, String nama_ustad, String kelas);

    String hapusData(int id_ustad);

}

public class CrudUstad extends Enkapsulasi implements Inter {
